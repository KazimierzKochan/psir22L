...
int main(void)
{
    ...
    thread_create(stack_thread_blinking_red, sizeof(stack_thread_blinking_red), THREAD_PRIORITY_MAIN - 1, THREAD_CREATE_STACKTEST, thread_blinking_red, NULL, "thread_red");
